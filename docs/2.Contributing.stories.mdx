...
If you are a new developer at **heycar**, make sure to check the **[Front-end Quickstart Guide](https://heycar.atlassian.net/wiki/spaces/DEP/pages/691146/Frontend+Onboarding)** in the Front-end Onboarding documentation. There you will see specific tips on accessing and configuring your environment specifically to Front-end development.

#### Basic requirements

There are some requirements and criteria for the whole **hey-ui** library. Make sure you are aware of them before starting development.
...
If you have questions or need more information about **hey-ui**, please go to **#global-design-system** on Slack.
