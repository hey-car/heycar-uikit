...
export const CollapseTemplate = args => {
...
<Story parameters={{ controls: { disable: true } }} name="Collapse">
  {CollapseTemplate.bind({})}
</Story>

<!-- Docs -->

<ComponentHeader name="Collapse" version={version} stage={1} />
...
<TabContainer
  tabs={[
    ...
    { label: 'Props', component: <Props of={Collapse} /> },
