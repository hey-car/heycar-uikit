...
In order to start working with screenshot testing locally, you need to start `Storybook`:
...
In order to generate and update screenshot tests locally, you need to install [docker](https://www.docker.com/) on your local machine, then run the next command.
